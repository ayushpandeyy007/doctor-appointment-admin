(self.webpackChunkdoctor_appointment_admin=self.webpackChunkdoctor_appointment_admin||[]).push([[3074],{94445:N=>{function H(p,s,y,f){for(var j=-1,D=p==null?0:p.length;++j<D;){var b=p[j];s(f,b,y(b),p)}return f}N.exports=H},7233:(N,H,p)=>{var s=p(97449);function y(f,j,D,b){return s(f,function(B,$,K){j(b,B,D(B),K)}),b}N.exports=y},88532:(N,H,p)=>{var s=p(94445),y=p(7233),f=p(45353),j=p(82261);function D(b,B){return function($,K){var le=j($)?s:y,de=B?B():{};return le($,b,f(K,2),de)}}N.exports=D},94710:(N,H,p)=>{var s=p(95292),y=p(88532),f=Object.prototype,j=f.hasOwnProperty,D=y(function(b,B,$){j.call(b,$)?b[$].push(B):s(b,$,[B])});N.exports=D},63074:(N,H,p)=>{"use strict";p.d(H,{P:()=>Bs});var s=p(92132),y=p(21272),f=p(83997),j=p(94061),D=p(50215),b=p(30893),B=p(85963),$=p(61485),K=p(99248),le=p(6239),de=p(67030),Ne=p(76079),Ve=p(57237),we=p(60888),He=p(44604),fe=p(4181),Fe=p(90151),Ge=p(68074),Je=p(12081),xe=p(12408),z=p(24093),_e=p(2129),ye=p(88761),ce=p(51187),M=p(2600),ne=p(412),Q=p(77965),V=p(48940),k=p(54894),F=p(93236),Xe=p(89032),Ye=p(59080),pe=p(94710),je=p(35223),S=p(79793),Ze=p(9005),ze=p(20415),Qe=p(74312),qe=p(44895),es=p(37679),ss=p(60043),ts=p(39404);const[ns,os]=(0,Xe.q)("PermissionsDataManager"),Y=()=>os("usePermissionsDataManager"),Oe=e=>Array.isArray(e)?e.reduce((t,o)=>(Array.isArray(o)?t.push(...Oe(o)):t.push(o),t),[]):[],J=e=>(0,F.F)(e)?Oe(Object.values(e).map(t=>(0,F.F)(t)?J(t):t)):[],Ae=(e,t,o)=>e.find(n=>n.action===t&&n.subject===o),is=e=>{const t=Ee(e.plugins),o=Ee(e.settings),n=be(e.collectionTypes),r=be(e.singleTypes);return[...t,...o,...n,...r]},Ee=e=>Object.values(e).reduce((t,o)=>{const n=Object.values(o).reduce((r,a)=>{const d=Object.entries(a).reduce((i,[l,{conditions:c,properties:{enabled:u}}])=>(u&&i.push({action:l,subject:null,conditions:ue(c),properties:{}}),i),[]);return[...r,...d]},[]);return[...t,...n]},[]),be=e=>Object.entries(e).reduce((o,n)=>{const[r,a]=n,d=Object.entries(a).reduce((i,l)=>{const[c,u]=l;if(!J(u).some(m=>m))return i;if(!u?.properties?.enabled){const m=Object.entries(u.properties).reduce((x,_)=>{const[h,C]=_;return x.properties[h]=Me(C),x},{action:c,subject:r,conditions:ue(u.conditions),properties:{}});return[...i,m]}return u.properties.enabled&&i.push({action:c,subject:r,properties:{},conditions:ue(u.conditions)}),i},[]);return[...o,...d]},[]),Me=(e,t="")=>Object.entries(e).reduce((o,n)=>{const[r,a]=n;return(0,F.F)(a)?[...o,...Me(a,`${t}${r}.`)]:(a&&!(0,F.F)(a)&&o.push(`${t}${r}`),o)},[]),ue=e=>Object.entries(e).filter(([,t])=>t).map(([t])=>t),Pe=(e,t=[])=>e.reduce((o,n)=>(o[n.id]=t.indexOf(n.id)!==-1,o),{}),ve=(e,t,o=[])=>e.reduce((n,{categoryId:r,childrenForm:a})=>{const d=a.reduce((i,l)=>(i[l.subCategoryId]=l.actions.reduce((c,u)=>{const g=Ae(o,u.action,null);return c[u.action]={properties:{enabled:g!==void 0},conditions:Pe(t,g?.conditions??[])},c},{}),i),{});return n[r]=d,n},{}),rs=(e,t,o)=>{const n=({children:r=[]},a,d="")=>r.reduce((i,l)=>{if(l.children)return{...i,[l.value]:n(l,a,`${d}${l.value}.`)};const c=a.indexOf(`${d}${l.value}`)!==-1;return i[l.value]=c,i},{});return e.reduce((r,a)=>{const d=t.properties.find(({value:i})=>i===a);if(d){const i=o?.properties[d.value]??[],l=n(d,i);r.properties[a]=l}return r},{properties:{}})},Te=({subjects:e,actions:t=[]},o,n=[])=>t.reduce((r,a)=>{const d=a.subjects.reduce((l,c)=>{const u=e.find(({uid:g})=>g===c)||null;return u&&(l[c]=u),l},{});if(Q(d))return r;const i=Object.keys(d).reduce((l,c)=>{const{actionId:u,applyToProperties:g}=a,_=d[c].properties.map(({value:P})=>P).every(P=>(g||[]).indexOf(P)===-1),h=Ae(n,u,c),C=Pe(o,h?.conditions??[]);if(l[c]||(l[c]={}),Q(g)||_)return l[c][u]={properties:{enabled:h!==void 0},conditions:C},l;const O=rs(g,d[c],h);return l[c][u]={...O,conditions:C},l},{});return Ye(r,i)},{}),Se=(e,t)=>Object.entries(pe(e,t)).map(([o,n])=>({category:o,categoryId:o.split(" ").join("-"),childrenForm:Object.entries(pe(n,"subCategory")).map(([r,a])=>({subCategoryName:r,subCategoryId:r.split(" ").join("-"),actions:a}))})),oe=e=>Object.keys(e).reduce((t,o)=>{const n=e[o];if((0,F.F)(n)&&!ne(n,"conditions"))return{...t,[o]:oe(n)};if((0,F.F)(n)&&ne(n,"conditions")&&!J(je(n,"conditions")).some(a=>a)){const a=Object.keys(n.conditions).reduce((d,i)=>(d[i]=!1,d),{});return{...t,[o]:{...n,conditions:a}}}return t[o]=n,t},{}),q=(e,t,o=!1)=>Object.keys(e).reduce((n,r)=>{const a=e[r];return r==="conditions"&&!o?(n[r]=a,n):(0,F.F)(a)?{...n,[r]:q(a,t,r==="fields")}:(n[r]=t,n)},{}),w=`${120/16}rem`,he=`${200/16}rem`,ie=`${53/16}rem`,ge=e=>e?Object.entries(e).reduce((t,[o,n])=>(o!=="conditions"&&(t[o]=n),t),{}):null,X=e=>{const t=ge(e),o=J(t);if(!o.length)return{hasAllActionsSelected:!1,hasSomeActionsSelected:!1};const n=o.every(a=>a),r=o.some(a=>a)&&!n;return{hasAllActionsSelected:n,hasSomeActionsSelected:r}},re=e=>e.charAt(0).toUpperCase()+e.slice(1),De=(0,S.Ay)(f.s)`
